...
class Autoencoder():
    ...
    def train(self, x_train, batch_size, epochs, run_folder, print_every_n_batches=100, initial_epoch=0, lr_decay=1):
        self.model.fit(x_train, x_train, batch_size=batch_size, epochs=epochs, initial_epoch=initial_epoch)
    ...
    def save_networks(self, run_folder):
        self.encoder.save(run_folder + '/weights/encoder-%sD.h5' % self.z_dim)
        self.decoder.save(run_folder + '/weights/decoder-%sD.h5' % self.z_dim)
